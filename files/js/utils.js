(function () {
  ...
  var K = {
    ...
    wa = {
      ...
      AZ: [
        ,
        [, , "(?:365\\d{3}|900200)\\d{3}|(?:[12457]\\d|60|88)\\d{7}", , , , , , , [9], [7]],
        [
          ,
          ,
      ...
      EE: [
        ,
        [, , "8\\d{9}|[4578]\\d{7}|(?:[3-8]\\d\\d|900)\\d{4}", , , , , , , [7, 8, 10]],
      ...
      FI: [
        ,
        [, , "(?:[124-7]\\d|3[0-46-9])\\d{8}|[1-9]\\d{5,8}|[1-35689]\\d{4}", , , , , , , [5, 6, 7, 8, 9, 10]],
      ...
      IN: [
        ,
        [, , "(?:00800|[2-9]\\d\\d)\\d{7}|1\\d{7,12}", , , , , , , [8, 9, 10, 11, 12, 13], [6, 7]],
        [
          ,
          ,
      ...
      KG: [
        ,
        [, , "(?:[235-7]\\d|99)\\d{7}|800\\d{6,7}", , , , , , , [9, 10], [5, 6]],
        [
          ,
          ,
      ...
      LA: [
        ,
        [, , "(?:2\\d|3)\\d{8}|(?:[235-8]\\d|41)\\d{6}", , , , , , , [8, 9, 10], [6]],
      ...
      TW: [
        ,
        [, , "(?:[24589]|7\\d)\\d{8}|[2-8]\\d{7}|2\\d{6}", , , , , , , [7, 8, 9, 10]],
        [
          ,
          ,
      ...
      YE: [
        ...
        [, , "17\\d{6}|(?:[12][2-68]|3[2358]|4[2-58]|5[2-6]|6[3-58]|7[24-68])\\d{5}", , , , "1234567", , , [7, 8], [6]],
      ...
      882: [
        ,
        [, , "1\\d{6,11}|3\\d{6}(?:\\d{2,5})?", , , , , , , [7, 8, 9, 10, 11, 12]],
        [, , , , , , , , , [-1]],
  ...
  function Ha(a) {
    var b = a.search(Aa);
    0 <= b
      ? ((a = a.substring(b)), (a = a.replace(Ca, "")), (b = a.search(Ba)), 0 <= b && (a = a.substring(0, b)))
      : (a = "");
    return a;
  }
  ...
  function Sa(a, b, c, d) {
    ...
    0 != h
      ...
      : (Ka(e),
        b.a(e.toString()),
        null != c ? ((h = y(g, 10)), u(f, 1, h)) : d && (delete f.a[6], f.c && delete f.c[6]));
    ...
    null != g &&
      ...
      2 != a && 4 != a && 5 != a && ((b = e), d && 0 < c.toString().length && u(f, 7, c.toString())));
    d = b.toString();
    a = d.length;
